...
### JOR-3RP Plan Database Jordan db 4513
database.id <- 4513
...
values.unique.attribute$sector[values.unique.attribute$sector=="BN"] <-"BASIC NEEDS"
...
#################################
db.4513.3rpLoc <- values.unique.attribute
