...
determineMonth <- function(start, end) {
  # Test to see if the dates can be interpreted correctly:
  test <- try(as.POSIXlt(start), silent = TRUE)
  if (inherits(test, "try-error")) stop("ambiguous date format: ", start)
...
db.5026.monitor <- values.unique.attribute
...
################## SYRIAN_WOMEN_IN_URBAN
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("SYRIAN_WOMEN_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_WOMEN_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                               grepl("", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName)  ,
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_WOMEN_IN_URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+44,250)
                                             ), values.unique.attribute$indic)
)
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_WOMEN_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_WOMEN_IN_URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+37,250)
                                             ), values.unique.attribute$indic)
)

################# SYRIAN_WOMEN_IN_CAMPS
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("SYRIAN_WOMEN_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Women"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("SYRIAN_WOMEN_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_WOMEN_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_WOMEN_IN_CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+38,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_WOMEN_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_WOMEN_IN_CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+31,250)
                                             ), values.unique.attribute$indic)
)
...
#################   SYRIAN_MEN_IN_URBAN
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("SYRIAN_MEN_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_MEN_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_MEN_IN_URBAN ", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+26,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_MEN_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
...
#################  SYRIAN_MEN_IN_CAMPS 
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("SYRIAN_MEN_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Men"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("SYRIAN_MEN_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_MEN_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_MEN_IN_CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+25,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_MEN_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
...
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("SYRIAN_GIRLS_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_GIRLS_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_GIRLS_IN_URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+36,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_GIRLS_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_GIRLS_IN_URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+37,250)
                                             ), values.unique.attribute$indic)
)

#################    SYRIAN_GIRLS_IN_CAMPS
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("SYRIAN_GIRLS_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Girls"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("SYRIAN_GIRLS_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_GIRLS_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_GIRLS_IN_CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+30,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_GIRLS_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_GIRLS_IN_CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+31,250)
                                             ), values.unique.attribute$indic)
)


#################    SYRIAN_BOYS_IN_CAMPS
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("SYRIAN_BOYS_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_BOYS_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_BOYS_IN_CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+37,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_BOYS_IN_CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_BOYS_IN_CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+38,250)
                                             ), values.unique.attribute$indic)
)
...
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("SYRIAN_BOYS_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Boys"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("SYRIAN_BOYS_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_BOYS_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_BOYS_IN_URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+37,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("SYRIAN_BOYS_IN_URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("SYRIAN_BOYS_IN_URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+38,250)
                                             ), values.unique.attribute$indic)
)
...
#################      EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN CAMPS
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Girls"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                               paste0("CAMPS"), values.unique.attribute$poptype)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("NEXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                               grepl("", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+34,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+35,250)
                                             ), values.unique.attribute$indic)
)

#################     EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN URBAN
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Girls"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+35,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("EXISTING FEMALE SYRIAN CHILDREN (0 to 17) IN URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+36,250)
                                             ), values.unique.attribute$indic)
)


#################    EXISTING MALE SYRIAN CHILDREN (0 to 17) IN CAMPS
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl(" EXISTING MALE SYRIAN CHILDREN (0 to 17) IN CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Boys"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl(" EXISTING MALE SYRIAN CHILDREN (0 to 17) IN CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl(" EXISTING MALE SYRIAN CHILDREN (0 to 17) IN CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr(" EXISTING MALE SYRIAN CHILDREN (0 to 17) IN CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+29,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl(" EXISTING MALE SYRIAN CHILDREN (0 to 17) IN CAMPS", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr(" EXISTING MALE SYRIAN CHILDREN (0 to 17) IN CAMPS", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+30,250)
                                             ), values.unique.attribute$indic)
)


#################     EXISTING MALE SYRIAN CHILDREN (0 to 17) IN URBAN
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("EXISTING MALE SYRIAN CHILDREN (0 to 17) IN URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Boys"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("EXISTING MALE SYRIAN CHILDREN (0 to 17) IN URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("EXISTING MALE SYRIAN CHILDREN (0 to 17) IN URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("EXISTING MALE SYRIAN CHILDREN (0 to 17) IN URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+35,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("EXISTING MALE SYRIAN CHILDREN (0 to 17) IN URBAN", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("EXISTING MALE SYRIAN CHILDREN (0 to 17) IN URBAN", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+36,250)
                                             ), values.unique.attribute$indic)
)


#################   MALE_IN_HOST_COMMUNITIES
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("MALE_IN_HOST_COMMUNITIES", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Men"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("MALE_IN_HOST_COMMUNITIES", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("MALE_IN_HOST_COMMUNITIES", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("MALE_IN_HOST_COMMUNITIES", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+38,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("MALE_IN_HOST_COMMUNITIES", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("MALE_IN_HOST_COMMUNITIES", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+31,250)
                                             ), values.unique.attribute$indic)
)


#################    FEMALE_IN_HOST_COMMUNITIES
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("FEMALE_IN_HOST_COMMUNITIES", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Women"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("FEMALE_IN_HOST_COMMUNITIES", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("FEMALE_IN_HOST_COMMUNITIES", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("FEMALE_IN_HOST_COMMUNITIES", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+33,250)
                                             ), values.unique.attribute$indic)
)


#################    WOMEN_IN_HOST_COMMUNITY
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl(" WOMEN_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Women"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("WOMEN_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl(" WOMEN_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr(" WOMEN_IN_HOST_COMMUNITY", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+31,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl(" WOMEN_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr(" WOMEN_IN_HOST_COMMUNITY", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+32,250)
                                             ), values.unique.attribute$indic)
)

#################    MEN_IN_HOST_COMMUNITY
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("MEN_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Men"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("MEN_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("MEN_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("MEN_IN_HOST_COMMUNITY", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+31,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("MEN_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("MEN_IN_HOST_COMMUNITY", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+32,250)
                                             ), values.unique.attribute$indic)
)

#################    BOYS_IN_HOST_COMMUNITY
values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("BOYS_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Boys"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("BOYS_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("BOYS_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("BOYS_IN_HOST_COMMUNITY", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+40,250)
                                             ), values.unique.attribute$indic)
)
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("BOYS_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName) &
                                             ...
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("BOYS_IN_HOST_COMMUNITY", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+33,250)
                                             ), values.unique.attribute$indic)
)


#################    GIRLS_IN_HOST_COMMUNITY

values.unique.attribute$gender <- with(values.unique.attribute,
                                       ifelse(grepl("GIRLS_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                              paste0("Girls"),values.unique.attribute$gender )
)
values.unique.attribute$poptype <- with(values.unique.attribute,
                                        ifelse(grepl("GIRLS_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
...
values.unique.attribute$indic <- with(values.unique.attribute,
                                      ifelse(grepl("GIRLS_IN_HOST_COMMUNITY", ignore.case = TRUE, fixed = FALSE, useBytes = FALSE,  values.unique.attribute$indicatorName),
                                             paste0(
                                               substr(values.unique.attribute$indicatorName ,
                                                      (regexpr("GIRLS_IN_HOST_COMMUNITY", values.unique.attribute$indicatorName , ignore.case=FALSE, fixed=TRUE))+19,250)
                                             ), values.unique.attribute$indic)
)
...
write.csv(indicbreak, file = "data/config/indicbreak2016.csv",na="")
#indicbreak <- read.csv("data/config/indicbreak2016-2.csv")
...
output$StartDate[output$StartDate=="01/01/2016"] <- "31/1/2016"
output$StartDate[output$StartDate=="01/02/2016"] <- "29/2/2016"
output$StartDate[output$StartDate=="01/03/2016"] <- "31/3/2016"
output$StartDate[output$StartDate=="01/04/2016"] <- "30/4/2016"
output$StartDate[output$StartDate=="01/05/2016"] <- "31/5/2016"
output$StartDate[output$StartDate=="01/06/2016"] <- "30/6/2016"
output$StartDate[output$StartDate=="01/07/2016"] <- "31/7/2016"
output$StartDate[output$StartDate=="01/08/2016"] <- "31/8/2016"
output$StartDate[output$StartDate=="01/09/2016"] <- "30/9/2016"
output$StartDate[output$StartDate=="01/10/2016"] <- "31/10/2016"
output$StartDate[output$StartDate=="01/11/2016"] <- "30/11/2016"
output$StartDate[output$StartDate=="01/12/2016"] <- "31/12/2016"
...
##Tweaking for blank data. It adds All the govenorates for all the sector with 0 Value entry for Dec 2016
...
#"BN"     "PROTECTION"      "HEALTH"          "EDUCATION"       "WASH "            "SHELTER"         "FOOD/LIVELIHOOD"
...
write.csv(output.education.benef, file = "out/monitor/2016/education/data.csv",na="")
...
write.csv(output.education.oth, file = "out/monitor/2016/education/dataother.csv",na="")
OE <- rbind(output.education.oth,output.education.benef)
write.csv(OE, file = "out/monitor/2016/education/dataind.csv",na="")
...
write.csv(output.health.benef, file = "out/monitor/2016/health/data.csv",na="")
output.health.oth <-  subset(output.health, output.health$Indicator == "")
output.health.oth$Indicator <- output.health.oth$Indicator2
write.csv(output.health.oth, file = "out/monitor/2016/health/dataother.csv",na="")
HE <- rbind(output.health.oth,output.health.benef)
write.csv(HE, file = "out/monitor/2016/health/dataind.csv",na="")
...
write.csv(output.food.benef, file = "out/monitor/2016/food/data.csv",na="")
output.food.oth <-  subset(output.food, output.food$Indicator == "")
output.food.oth$Indicator <- output.food.oth$Indicator2
write.csv(output.food.oth, file = "out/monitor/2016/food/dataother.csv",na="")
FE <- rbind(output.food.oth,output.food.benef)
write.csv(FE, file = "out/monitor/2016/food/dataind.csv",na="")

output.basicneeds <-  subset(output, output$sector == "BN")
...
write.csv(output.basicneeds.benefFinal, file = "out/monitor/2016/basicneeds/data.csv")
...
write.csv(output.basicneeds.oth, file = "out/monitor/2016/basicneeds/dataother.csv",na="")
BE <- rbind(output.basicneeds.oth,output.basicneeds.benef)
write.csv(BE, file = "out/monitor/2016/basicneeds/dataind.csv",na="")
...
write.csv(output.protection.benef, file = "out/monitor/2016/protection/data.csv",na="")
...
write.csv(output.protection.oth, file = "out/monitor/2016/protection/dataother.csv",na="")
PE <- rbind(output.protection.oth,output.protection.benef)
write.csv(PE, file = "out/monitor/2016/protection/dataind.csv",na="")
...
write.csv(output.shelter.benef, file = "out/monitor/2016/shelter/data.csv",na="")
...
write.csv(output.shelter.oth, file = "out/monitor/2016/shelter/dataother.csv",na="")
SE <- rbind(output.shelter.oth,output.shelter.benef)
write.csv(SE, file = "out/monitor/2016/shelter/dataind.csv",na="")
...
write.csv(output.wash.benef, file = "out/monitor/2016/wash/data.csv",na="")
output.wash.oth <-  subset(output.wash, output.wash$Indicator == "")
output.wash.oth$Indicator <- output.wash.oth$Indicator2
write.csv(output.wash.oth, file = "out/monitor/2016/wash/dataother.csv",na="")
WE <- rbind(output.wash.oth,output.wash.benef)
write.csv(WE, file = "out/monitor/2016/wash/dataind.csv",na="")
...
output.zaatari.benef$sector[output.zaatari.benef$sector=="BN"] <- "BASICNEEDS"
...
write.csv(output.zaatari.benefFinal, file = "out/monitor/2016/zaatari/data.csv",na="")
...
output.azraq.benef$sector[output.azraq.benef$sector=="BN"] <- "BASICNEEDS"
...
write.csv(output.azraq.benefFinal, file = "out/monitor/2016/azraq/data.csv",na="")
...
countrywide$sector[countrywide$sector=="BN"] <- "BASICNEEDS"
countrywide$sector[countrywide$sector=="FOOD/LIVELIHOOD"] <- "FOOD"
write.csv(countrywide, file = "out/monitor/2016/countrywide/data.csv",na="")


db.1064.monitor <- values.unique.attribute
write.csv(db.5026.monitor, file = "out/monitordata.csv",na="")
